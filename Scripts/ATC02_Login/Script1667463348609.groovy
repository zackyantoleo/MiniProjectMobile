...
Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText - Email (1)'), 'zackmobile@gmail.com', 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText - Password (1)'), 'zack123', 0)
...
Mobile.verifyElementVisible(findTestObject('android.login.Button'), 0)
